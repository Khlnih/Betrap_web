    ...
    container.innerHTML = `
      <nav class="navbar" id="navbar">
        <a class="navbar-brand" href="${root}index.html">
          <img src="${root}assets/images/logo.png" alt="Trap Connect" style="height:48px; width:auto; object-fit:contain;">
        </a>
          ...
          <div class="footer-grid">
            <div class="footer-brand">
              <div class="navbar-brand" style="color:var(--gold-light);font-size:1.4rem">
                <img src="${root}assets/images/logo.png" alt="Trap Connect" style="height:56px; width:auto; object-fit:contain;">
              </div>

...
app.get('/api/seed-new', async (req, res) => {
    try {
        ...
        const newServices = [
            { id: 'be1', providerId: 'p1', name: 'Bộ 1 - Hồng Nhạt Thanh Khiết', desc: 'Nam: Áo dài tay cổ đứng màu hồng nhạt trơn, chất liệu lụa satin. Nữ: Áo dài tay rộng màu hồng nhạt, thân áo có hoa văn chìm, phần ngực trang trí hoa 3D đỏ nổi bật. Đặc điểm nổi bật: Phong cách thanh lịch, dịu dàng', img: 'assets/images/betrap-1.jpg' },
            { id: 'be2', providerId: 'p2', name: 'Bộ 2 - Hồng Cam Lấp Lánh', desc: 'Nam: Áo dài tay cổ đứng màu hồng nhạt trơn, chất liệu lụa satin, áo hồng nhạt. Nữ: Áo màu hồng cam ánh kim (shimmer), họa tiết hoa chìm tinh tế, viền cổ trang trí tua rua. Đặc điểm nổi bật: Áo nữ có độ óng ánh đẹp dưới nắng, sang trọng và hiện đại.', img: 'assets/images/betrap-2.jpg' },
            { id: 'be3', providerId: 'p3', name: 'Bộ 3 - Hồng Phấn Hoa Văn', desc: 'Nam: Áo hồng nhạt. Nữ: Áo hồng nhạt họa tiết hoa lớn nổi, cổ cao đính ngọc trai/đá, tay rộng. Đặc điểm nổi bật: Họa tiết nổi bật hơn, mang cảm giác quý phái, cổ điển.', img: 'assets/images/betrap-3.jpg' },
            { id: 'be4', providerId: 'p1', name: 'Bộ 4 - Ngà Kem Truyền Thống', desc: 'Nam & Nữ: Cùng tone kem ngà (ivory), chất liệu satin bóng nhẹ. Nữ: Áo có họa tiết hoa chìm, cầm hoa sen vàng. Đặc điểm nổi bật: Sang trọng, tinh khiết, rất hợp chụp ảnh cưới hoặc lễ trọng.', img: 'assets/images/betrap-4.jpg' },
            { id: 'be5', providerId: 'p2', name: 'Bộ 5 - Trắng Đỏ Kiêu Sa', desc: 'Nam: Kem ngà. Nữ: Áo trắng trong suốt nhẹ, viền cổ đỏ, buộc nơ đỏ, mặc cùng quần đỏ. Đặc điểm nổi bật: Phong cách hiện đại, nổi bật nhờ điểm nhấn đỏ, trẻ trung và cá tính.', img: 'assets/images/betrap-5.jpg' },
            { id: 'be6', providerId: 'p3', name: 'Bộ 6 - Ngà Voan Mỏng', desc: 'Nam: Kem ngà. Nữ: Áo voan kem mỏng nhẹ, lớp trong, cầm hoa vàng. Đặc điểm nổi bật: Rất nhẹ nhàng, bay bổng, phù hợp phong cách nhẹ nhàng, thơ mộng.', img: 'assets/images/betrap-6.jpg' },
            { id: 'be7', providerId: 'p1', name: 'Bộ 7 - Trắng Đỏ May Mắn', desc: 'Nam: Kem ngà. Nữ: Áo trắng viền đỏ, quần đỏ, đầu đội bờm đỏ. Đặc điểm nổi bật: Mang đậm màu sắc truyền thống, tượng trưng cho may mắn, hạnh phúc.', img: 'assets/images/betrap-7.jpg' },
            { id: 'be8', providerId: 'p2', name: 'Bộ 8 - Xanh Olive Thanh Bình', desc: 'Nam: Xanh olive nhạt. Nữ: Xanh lá nhạt thêu hoa nhỏ, tay voan, cầm hoa trắng-vàng. Đặc điểm nổi bật: Tone màu mát mẻ, tươi mới', img: 'assets/images/betrap-8.jpg' },
            { id: 'be9', providerId: 'p3', name: 'Bộ 9 - Hồng Sen Đỏ', desc: 'Nam: Hồng nhạt. Nữ: Áo hồng nhạt họa tiết, mặc quần đỏ. Đặc điểm nổi bật: Kết hợp hồng - đỏ hài hòa, sang trọng và rực rỡ.', img: 'assets/images/betrap-9.jpg' },
            { id: 'be10', providerId: 'p1', name: 'Bộ 10 - Hồng Gradient', desc: 'Nam: Hồng nhạt. Nữ: Áo hồng gradient (phần trên đậm, dưới nhạt chuyển sang xanh ngọc), họa tiết óng ánh. Đặc điểm nổi bật: Thiết kế hiện đại, gradient độc đáo, cực kỳ bắt mắt.', img: 'assets/images/betrap-10.jpg' }
        ];

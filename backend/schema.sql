...
('s3', 'p2', 'be-trap', N'Gói Bê Tráp Áo Dài Đỏ', N'Đội hình 7 người, áo dài đỏ rực rỡ mang lại may mắn cho ngày cưới.', 2100000, N'buổi', 'assets/images/betrap-4.jpg', N'Hà Nội', 4.9, 35, N'["7 người","Áo dài đỏ"]'),
('s4', 'p2', 'be-trap', N'Gói Bê Tráp Áo Dài Vàng', N'Đội hình 7 người, trang phục áo dài vàng kim sang trọng.', 2200000, N'buổi', 'assets/images/betrap-5.jpg', N'Hà Nội', 4.8, 21, N'["7 người","Áo dài vàng"]'),
...
('s6', 'p3', 'be-trap', N'Gói Bê Tráp Kèm Xe Hoa', N'Đội bê tráp 5 người kèm dịch vụ xe hoa sang trọng phục vụ đưa rước.', 5000000, N'ngày', 'assets/images/betrap-25.jpg', N'Hà Nội', 4.9, 12, N'["5 người","Xe hoa"]'),
('s7', 'p3', 'be-trap', N'Gói Bê Tráp Truyền Thống Xưa', N'Đội hình 7 người mặc áo tấc, khăn vấn đậm chất truyền thống Bắc Bộ.', 2800000, N'buổi', 'assets/images/betrap-12.jpg', N'Hà Nội', 4.8, 15, N'["7 người","Áo tấc","Cổ điển"]'),
('s8', 'p2', 'be-trap', N'Gói Bê Tráp Hiện Đại', N'Đội hình 9 người, trang phục suit và áo dài cách tân hiện đại.', 3200000, N'buổi', 'assets/images/betrap-22.jpg', N'Hà Nội', 4.6, 28, N'["9 người","Hiện đại"]'),
...
('s10', 'p2', 'ao-dai', N'Thuê Áo Dài Cặp Đôi (Đỏ)', N'Combo áo dài cặp cô dâu chú rể màu đỏ truyền thống.', 1500000, N'ngày', 'assets/images/aodai-2.jpg', N'Hà Nội', 4.8, 22, N'["Cặp đôi","Đỏ"]'),
('s11', 'p2', 'ao-dai', N'Áo Dài Bê Tráp Nữ (Hồng)', N'Cho thuê theo dàn 5-7 bộ, áo dài hồng phấn nhẹ nhàng cho đội bê tráp.', 150000, N'bộ', 'assets/images/aodai-3.jpg', N'Hà Nội', 4.7, 45, N'["Bê tráp","Hồng","Nữ"]'),
...
('s13', 'p2', 'ao-dai', N'Áo Dài Bê Tráp Nữ (Vàng)', N'Áo dài vàng tươi tắn, tay bồng hiện đại cho dàn bưng quả.', 160000, N'bộ', 'assets/images/aodai-5.jpg', N'Hà Nội', 4.9, 38, N'["Bê tráp","Vàng"]'),
('s14', 'p3', 'ao-dai', N'Combo 9 Bộ Áo Dài Nam Nữ', N'Trọn gói thuê 9 bộ áo dài nam (xanh) và nữ (hồng) ton-sur-ton.', 1400000, N'ngày', 'assets/images/aodai-6.jpg', N'Hà Nội', 5.0, 19, N'["Combo 9 bộ","Nam nữ"]'),
...
('s16', 'p2', 'ao-dai', N'Áo Dài Trắng Tinh Khôi', N'Áo dài lụa trắng trơn, thanh lịch và tinh tế cho ngày ăn hỏi.', 700000, N'ngày', 'assets/images/aodai-8.jpg', N'Hà Nội', 4.9, 31, N'["Cô dâu","Trắng","Trơn"]'),
...
('s18', 'p2', 'lam-trap', N'Mâm Tráp 7 Lễ Cao Cấp', N'Bộ 7 mâm tráp được trang trí hoa tươi nghệ thuật, cầu kỳ sang trọng.', 5800000, N'bộ', 'assets/images/lamtrap-2.jpg', N'Hà Nội', 4.9, 41, N'["7 mâm","Hoa tươi","Cao cấp"]'),
('s19', 'p3', 'lam-trap', N'Mâm Tráp 9 Lễ Rồng Phượng', N'Bộ 9 mâm tráp cực khủng với tráp rồng phượng trái cây sống động.', 8500000, N'bộ', 'assets/images/lamtrap-3.jpg', N'Hà Nội', 5.0, 26, N'["9 mâm","Rồng phượng","VIP"]'),
...
('s21', 'p2', 'lam-trap', N'Tráp Rượu Thuốc Tây Nhập', N'Mâm rượu Chivas và thuốc lá ngoại nhập trang trí hoa lụa.', 1500000, N'mâm', 'assets/images/lamtrap-5.jpg', N'Hà Nội', 4.7, 34, N'["Rượu thuốc","Cao cấp"]'),
...
('s23', 'p3', 'lam-trap', N'Gói 7 Mâm Tráp Hiện Đại', N'Sử dụng mâm mica trong suốt, hoa tươi tone pastel hiện đại.', 6200000, N'bộ', 'assets/images/lamtrap-7.jpg', N'Hà Nội', 4.8, 22, N'["7 mâm","Mica","Hiện đại"]'),
('s24', 'p2', 'lam-trap', N'Tráp Heo Quay Cưới Hỏi', N'Heo sữa quay nguyên con, trang trí nơ đỏ mâm son.', 1800000, N'mâm', 'assets/images/lamtrap-8.jpg', N'Hà Nội', 4.9, 47, N'["Heo quay","Mặn"]');
GO
